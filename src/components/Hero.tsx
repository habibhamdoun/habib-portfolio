      ...
      <div className="container mx-auto max-w-5xl">
        <div className="flex flex-col items-start">
          ...
          >
            ...
            Currently, I'm focused on building accessible, human-centered products while pursuing 
            my Computer Engineering degree at Lebanese American University.
          </p>
          <a 
            href="#projects" 
            className={`inline-flex items-center gap-2 bg-transparent hover:bg-portfolio-accent/10 text-portfolio-accent font-mono border border-portfolio-accent px-7 py-4 rounded transition-all duration-300 transform ${
              isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
            }`}
