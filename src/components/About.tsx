      ...
      <div className='container mx-auto max-w-4xl'>
        ...
        <div className='grid md:grid-cols-3 gap-12'>
          <div className='md:col-span-2 text-portfolio-text'>
            <p className='mb-4'>
              Hello! I'm Habib, a Full-Stack Developer with experience in
              building modern web applications using React, TypeScript, and
              Node.js. My journey in web development started during my time at
              Saint George School where I graduated with honors as the
              Valedictorian.
            </p>
            <p className='mb-4'>
              Currently pursuing a Bachelor's degree in Computer Engineering at
              Lebanese American University, I combine my academic knowledge with
              practical experience from internships and freelance projects. I
              recently completed an internship at BAMPTEE as a Full-Stack
              Development Intern where I developed reusable components and
              optimized existing code using React TypeScript.
            </p>
            <p className='mb-4'>
              I'm passionate about creating efficient, responsive, and
              user-friendly applications. My experience includes working with:
            </p>

            <ul className='grid grid-cols-2 gap-x-4 gap-y-2 mt-6 font-mono text-sm'>
              <li className='flex items-center'>
                <span className='text-portfolio-accent mr-2'>▹</span> JavaScript
                (ES6+)
              </li>
              <li className='flex items-center'>
