  ...
  return (
    ...
    >
      <div className='container mx-auto max-w-4xl text-center'>
        ...
        <h2 className='text-4xl sm:text-5xl font-bold text-portfolio-lighterText mb-6'>
          Get In Touch
        </h2>
        <p className='text-portfolio-text max-w-xl mx-auto mb-12'>
          I'm currently looking for new opportunities. Whether you have a
          question or just want to say hi, I'll do my best to get back to you as
          soon as possible!
        </p>
        ...
        <div className='grid md:grid-cols-3 gap-5 text-center md:text-left mt-16'>
          <div className='flex flex-col items-center md:items-start'>
            ...
            <h3 className='text-lg font-medium text-portfolio-lighterText mb-2'>
              Email
            </h3>
            <a
              href='mailto:HabibHamdoun@gmail.com'
